...
<main class="mars-current-weather">
    ...
    <div class="temp">
        ...
        <p class="reading">
            High:
            <span data-current-temp-high data-temp></span>
            °<span data-temp-unit>C</span>
        </p>
        <p class="reading">
            Low:
            <span data-current-temp-low data-temp></span>
            °<span data-temp-unit>C</span>
        </p>
    </div>
...
<template data-previous-sol-template>
    <div class="previous-day">
        ...
        <p class="previous-day__temp">
            High:
            <span data-temp-high data-temp></span>
            °<span data-temp-unit>C</span>
        </p>
        <p class="previous-day__temp">
            Low:
            <span data-temp-low data-temp></span>
            °<span data-temp-unit>C</span>
        </p>
